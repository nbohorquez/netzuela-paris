...
EventObject.prototype._getEvent = function (eventName, create) {
...
EventObject.prototype.attachEvent = function (eventName, handler) {
...
EventObject.prototype.detachEvent = function (eventName, handler) {
    // Get the Array of Event Handlers
...
EventObject.prototype.raiseEvent = function (eventName, eventArgs) {
...
EventObject.prototype._getEventHandler = function (eventName) {
