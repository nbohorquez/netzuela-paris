...
def main(global_config, **settings):
	...
	config.add_route('productos', '/productos/cat{categoria_id}geo{region_geografica_id}')
	config.add_route('tiendas', '/tiendas/cat{categoria_id}geo{region_geografica_id}')
	...
	#config.add_route('categorias', '/categorias.json')
	config.scan()
